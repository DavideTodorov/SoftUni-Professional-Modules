...
public class ControllerImpl implements Controller {
    ...
    public String startRace(String raceName) {
        ...
        builder.append(String.format(DRIVER_FIRST_POSITION, driverArrayList.get(0).getName(), raceName))
                .append(System.lineSeparator());
        builder.append(String.format(DRIVER_SECOND_POSITION, driverArrayList.get(1).getName(), raceName))
                .append(System.lineSeparator());
        builder.append(String.format(DRIVER_THIRD_POSITION, driverArrayList.get(2).getName(), raceName))
                .append(System.lineSeparator());
