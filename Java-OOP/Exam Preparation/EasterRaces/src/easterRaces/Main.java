...
public class Main {
    public static void main(String[] args) throws IOException {
        CarRepository motorcycleRepository = new CarRepository();
        RaceRepository raceRepository = new RaceRepository();
        DriverRepository riderRepository = new DriverRepository();

        Controller controller = new ControllerImpl(riderRepository,
