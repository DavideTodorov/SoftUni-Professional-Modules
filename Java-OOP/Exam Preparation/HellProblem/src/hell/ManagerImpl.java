...
public class ManagerImpl implements Manager {
    ...
    public String addRecipe(List<String> arguments) {
        ...
        Recipe recipe = new RecipeItem(itemName, strengthBonus, agilityBonus,
                intelligenceBonus, hitPointsBonus,
    ...
    public String inspect(List<String> arguments) {
        return heroes.get(arguments.get(1)).toString();
    }
    ...
    public String quit() {
        ...
        for (Hero hero : ordered) {
            output.append(index).append(". ").append(hero.getClass().getSimpleName()).append(": ")
                    .append(hero.getName()).append(System.lineSeparator());
            ...
            if (hero.getItems().isEmpty()) {
                output.append("###Items: None").append(System.lineSeparator());
            } else {
                output.append("###Items: ");
